...
Original file is located at
    https://colab.research.google.com/drive/1dZdNmU0jc4HjoNGbPLE-YVIaWJPAVK0Z
"""
...
def derivadas_regressao_reg(theta, X, y, beta):
    return -2 * ((y - X @ theta) @ X) + 2 * beta * theta
...
theta_reg = gd_reg(theta, derivadas_regressao_reg, X, y, beta = 0.1)

print("R2 em treino com regularizacao = ", multiple_r_squared(X_train, y_train, theta_reg))
print("R2 em teste com regularizacao = ", multiple_r_squared(X_test, y_test, theta_reg))
